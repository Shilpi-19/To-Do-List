...
Label(root,image=dockImage,bg="#32405b").place(x=35,y=30)

noteImage=PhotoImage(file="Image/task.png")
Label(root,image=noteImage,bg="#32405b").place(x=340,y=30)
...
button=Button(frame,text="ADD",font="arial 20 bold",width=6,bg="#6e260e",fg="#fff",bd=0,command=addTask)
